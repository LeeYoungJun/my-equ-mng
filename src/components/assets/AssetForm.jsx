  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2.5 justify-end mt-2">
        ...
        <button type="submit" className="px-6 py-2.5 rounded-xl bg-dark text-white text-sm font-semibold cursor-pointer disabled:opacity-40" disabled={!form.manufacturer || !form.model}>
          {editItem ? "수정" : "등록"}
        </button>
      </div>
    </form>
